...
`cloud-itonami-isco-7124` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, site or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind Insulation Crew Governor.
...
- Never widen the closed op-allowlist to include an
  insulation-installation-execution op, or a site-safety-officer-override op,
