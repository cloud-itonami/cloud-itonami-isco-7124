(ns insulationcrew.actor
  "InsulationCrewActor — the ISCO-08 7124 insulation job-site
  ...
  The unconditional invariant: the Insulation Crew Advisor can never
  directly commit an operating record the InsulationCrewGovernor
  refuses, and can never make this actor finalize an
  insulation-installation-execution decision or override a site safety
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs insulation-installation
  work or authorizes insulation-installation execution itself."
...
(defn build-graph
  "Build a compiled InsulationCrewActor graph. `store` implements
  `insulationcrew.store/Store`. `advisor` implements
  `insulationcrew.advisor/Advisor` (defaults to `mock-advisor`).
